...
mks  ALL=(ALL) NOPASSWD: /home/mks/klipper_config/3dwork-klipper-qidi/scripts/3dwork-update.sh
#EOF
...
install_hooks()
{
	...
	then
 	   ln -s /home/mks/klipper_config/3dwork-klipper-qidi/scripts/3dwork-post-merge.sh /home/mks/klipper_config/3dwork-klipper-qidi/.git/hooks/post-merge
	fi
}
